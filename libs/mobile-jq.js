...
// imageName, showAnno are globals
...
// tileSize, zoomLevels are globals
function init()
	{
	...
	//$(".slider_info").text( "slice: (" + currentSlice + " / " + maximumSlice + "), , zoom: (" + zoom + " / " + this.map.getNumZoomLevels() + ")" );
...
timersec = $.timer(function()
	...
	if(isFollowing == true)
		...
		if(isWaiting == false)
			...
			} // END if(isWaiting == false)
		} // END if(isFollowing == true)
	}); // END $.timer(function()
...
function change_annotation_mode(event, ui, num)
	{
	var themes = ["a","b","e"];
