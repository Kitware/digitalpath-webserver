...
if($mongo_question['type'] == "note"){
  //Find a way to redirect to notemaker.php
}
...
<script type="text/javascript"> 
  ...
  function saveConstants() {
    ...
    $.post("setquestion.php", {qid: qid, qtitle:questiontitle, qtext: questiontext, choices: questionchoices, cam: camValues, corr: correct, annotations:annots, expl:explanation}, function(cs){
        //alert(cs);
    });
  }
