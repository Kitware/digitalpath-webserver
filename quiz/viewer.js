...
function Viewer (canvas, viewport, cache) {
...
Viewer.prototype.HandleMouseMove = function(x,y, dx,dy, shiftKeyPressed) {
...
Viewer.prototype.HandleKeyPress = function(keyCode) {
