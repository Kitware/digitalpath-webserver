...
$c3->update(array('qid'=>new MongoId($id)), array('$set'=>array('qtext'=>$qtext, 'title'=>$title, 'choices'=>$choices2, 'cam'=>$cam, 'correct'=>$correct, 'annotations'=>$annots, 'explanation'=>$expl)), true);
