...
<script type="text/javascript"> 
  ...
  function saveConstants() {
    ...
    $.post("setnote.php", {qid: qid, title:notetitle, text: notetext, cam: camValues, annotations:annots}, function(cs){
        //alert(cs);
    });
  }
  ...
  $(document).ready(function() {
    document.getElementById("notetext").innerHTML = QUESTION.qtext;
...
<body onload="webGLStart();">
  <div class="container ui-widget" >
    ...
    <div class="form ui-widget-content" >
      ...
      <button id="savenote" onclick="savenote();" >Save Note</button><br />
    </div>
  </div>
